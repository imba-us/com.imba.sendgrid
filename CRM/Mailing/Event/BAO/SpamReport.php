 ...
 *
 */
class CRM_Mailing_Event_BAO_SpamReport extends CRM_Mailing_Event_DAO_SpamReport {
   ...
   * @static
   */
  public static function report($queue_id) {
    ...
    $q->id = $queue_id;
    if ($q->find(TRUE)) {
      $oe                 = new CRM_Mailing_Event_BAO_SpamReport();
