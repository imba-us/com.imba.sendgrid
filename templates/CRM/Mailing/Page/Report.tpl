...
{if $report.jobs.0.start_date}
  ...
  <tr><td class="label"><a href="{$report.event_totals.links.spam}">{ts}Spam Reports{/ts}</a></td>
      <td>{$report.event_totals.spam} ({$report.event_totals.spam_rate|string_format:"%0.2f"}%)</td>
      <td>{$report.event_totals.actionlinks.spam}</td></tr>
