     ...
     <table class="form-layout-compressed">
           <tr class="crm-smtp-form-block-outBound_option">
            ...
            <fieldset>
                ...
                <div id="help">
                	{ts}<p>If you are using the SendGrid Event Notification app for bounce processing and authentication is desired, please provide the following information.<p>{/ts}
                </div>
                <legend>{ts}SendGrid Event Notification Configuration{/ts}</legend>
                <table class="form-layout-compressed">
                	<tr>
                		<td class="label">{$form.sendgrid_username.label}</td>
                		<td>{$form.sendgrid_username.html}</td>
                	</tr>
                	<tr>
                		<td class="label">{$form.sendgrid_password.label}</td>
                		<td>{$form.sendgrid_password.html}<br />
